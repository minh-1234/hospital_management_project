...
const UsageHisInfoBlock = ({ equipmentData }) => {
    ...
    const handleDelete = () => {
        axios.delete(`${env.URL_BACKEND}/v1/equipments/` + equipmentData.id + "/usageHistory/" + usageHistory[currentPage - 1].id, { withCredentials: true })
    ...
    const handleSubmit = (event) => {
        ...
        if (form.checkValidity() === false) {
            ...
            if (isUpdate) {
                axios.put(`${env.URL_BACKEND}/v1/equipments/` + equipmentData.id + "/usageHistory/" + usageHistory[currentPage - 1].id, data, { withCredentials: true })
                    .then(() => {
                ...
                axios.post(`${env.URL_BACKEND}/v1/equipments/` + equipmentData.id + "/usageHistory/", data, { withCredentials: true })
                    .then(() => {
                        window.location.reload();
                    })
                    .catch((error) => {
